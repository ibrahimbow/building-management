...
public class ManagerChatController {
    ...
    public ResponseEntity<List<ChatMessageResponse>> getMessages() {
        ...
        final List<ChatMessageResponse> response = getBuildingChatUseCase.getMessagesForCurrentManagerBuilding(currentUser.userId())
                                                                         .stream()
    ...
    public ResponseEntity<ChatMessageResponse> sendMessage(@Valid @RequestBody final SendChatMessageRequest request) {
        ...
        final ChatMessageResponse response = chatApiMapper.toResponse(sendChatMessageUseCase.sendFromCurrentManagerBuilding(command));
